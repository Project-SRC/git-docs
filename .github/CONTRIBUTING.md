...
Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/) where the questions should be tagged with tag `<type>`.
...
[coc]: https://github.com/<project-link>/code-of-conduct/blob/master/CODE_OF_CONDUCT.md
